...
import { ps4Games, bannerImages } from '../lib/gameData';
import { Search } from 'lucide-react';

const PS4: React.FC = () => {
  const [searchQuery, setSearchQuery] = useState('');
  const [filteredGames, setFilteredGames] = useState(ps4Games);
      ...
      <section className="pt-24 md:pt-32 pb-8">
        <div className="container mx-auto px-4 md:px-6">
          <Banner 
            ...
            subtitle="Discover an incredible selection of games for your PS4 console."
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="bg-azgaming-gray/20 backdrop-blur-md rounded-xl p-4 md:p-6 border border-azgaming-gray/10">
            ...
            <div className="mt-4 text-sm text-gray-400">
              Showing {filteredGames.length} of {ps4Games.length} games
            </div>
          </div>
        </div>
      </section>
