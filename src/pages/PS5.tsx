...
import { ps5Games, bannerImages } from '../lib/gameData';
import { Search } from 'lucide-react';

const PS5: React.FC = () => {
  const [searchQuery, setSearchQuery] = useState('');
  const [filteredGames, setFilteredGames] = useState(ps5Games);
      ...
      <section className="pt-24 md:pt-32 pb-8">
        <div className="container mx-auto px-4 md:px-6">
          <Banner 
            ...
            subtitle="Experience next-gen gaming with our collection of PS5 titles."
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="bg-azgaming-gray/20 backdrop-blur-md rounded-xl p-4 md:p-6 border border-azgaming-gray/10">
            ...
            <div className="mt-4 text-sm text-gray-400">
              Showing {filteredGames.length} of {ps5Games.length} games
            </div>
          </div>
        </div>
      </section>
